...
type UpdateHandScoreRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	HandId       uint64                                `protobuf:"varint,1,opt,name=hand_id,json=handId,proto3" json:"hand_id,omitempty"`
	PlayerScores []*UpdateHandScoreRequest_PlayerScore `protobuf:"bytes,2,rep,name=player_scores,json=playerScores,proto3" json:"player_scores,omitempty"`
}

func (x *UpdateHandScoreRequest) Reset() {
	*x = UpdateHandScoreRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateHandScoreRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateHandScoreRequest) ProtoMessage() {}

func (x *UpdateHandScoreRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_services_hand_v1_service_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateHandScoreRequest.ProtoReflect.Descriptor instead.
func (*UpdateHandScoreRequest) Descriptor() ([]byte, []int) {
	return file_app_services_hand_v1_service_proto_rawDescGZIP(), []int{8}
}

func (x *UpdateHandScoreRequest) GetHandId() uint64 {
	if x != nil {
		return x.HandId
	}
	return 0
...
func (x *UpdateHandScoreRequest) GetPlayerScores() []*UpdateHandScoreRequest_PlayerScore {
	if x != nil {
		return x.PlayerScores
	}
	return nil
...
type UpdateHandScoreResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UpdateHandScoreResponse) Reset() {
	*x = UpdateHandScoreResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateHandScoreResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateHandScoreResponse) ProtoMessage() {}

func (x *UpdateHandScoreResponse) ProtoReflect() protoreflect.Message {
	mi := &file_app_services_hand_v1_service_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateHandScoreResponse.ProtoReflect.Descriptor instead.
func (*UpdateHandScoreResponse) Descriptor() ([]byte, []int) {
	return file_app_services_hand_v1_service_proto_rawDescGZIP(), []int{9}
}

func (x *UpdateHandScoreResponse) GetHandScore() *HandScore {
	if x != nil {
		return x.HandScore
	}
	return nil
...
type UpdateHandScoreRequest_PlayerScore struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UpdateHandScoreRequest_PlayerScore) Reset() {
	*x = UpdateHandScoreRequest_PlayerScore{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateHandScoreRequest_PlayerScore) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateHandScoreRequest_PlayerScore) ProtoMessage() {}

func (x *UpdateHandScoreRequest_PlayerScore) ProtoReflect() protoreflect.Message {
	mi := &file_app_services_hand_v1_service_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateHandScoreRequest_PlayerScore.ProtoReflect.Descriptor instead.
func (*UpdateHandScoreRequest_PlayerScore) Descriptor() ([]byte, []int) {
	return file_app_services_hand_v1_service_proto_rawDescGZIP(), []int{8, 0}
}

func (x *UpdateHandScoreRequest_PlayerScore) GetPlayerId() uint64 {
	if x != nil {
		return x.PlayerId
	}
	return 0
...
func (x *UpdateHandScoreRequest_PlayerScore) GetScore() int32 {
	if x != nil {
		return x.Score
	}
	return 0
...
func (x *UpdateHandScoreRequest_PlayerScore) GetGameNumber() uint32 {
	if x != nil {
		return x.GameNumber
	}
	return 0
...
var file_app_services_hand_v1_service_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
}
...
var file_app_services_hand_v1_service_proto_goTypes = []interface{}{
	...
	(*UpdateHandScoreRequest)(nil),              // 8: app.services.hand.v1.UpdateHandScoreRequest
	(*UpdateHandScoreResponse)(nil),             // 9: app.services.hand.v1.UpdateHandScoreResponse
	...
	(*UpdateHandScoreRequest_PlayerScore)(nil),  // 14: app.services.hand.v1.UpdateHandScoreRequest.PlayerScore
...
var file_app_services_hand_v1_service_proto_depIdxs = []int32{
	...
	14, // 8: app.services.hand.v1.UpdateHandScoreRequest.player_scores:type_name -> app.services.hand.v1.UpdateHandScoreRequest.PlayerScore
	1,  // 9: app.services.hand.v1.UpdateHandScoreResponse.hand_score:type_name -> app.services.hand.v1.HandScore
	...
	8,  // 15: app.services.hand.v1.HandService.UpdateHandScore:input_type -> app.services.hand.v1.UpdateHandScoreRequest
	...
	9,  // 19: app.services.hand.v1.HandService.UpdateHandScore:output_type -> app.services.hand.v1.UpdateHandScoreResponse
...
func file_app_services_hand_v1_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_app_services_hand_v1_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateHandScoreRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_app_services_hand_v1_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateHandScoreResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_app_services_hand_v1_service_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateHandScoreRequest_PlayerScore); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
