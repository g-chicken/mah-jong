...
type CreateHandRequest_PlayerScore struct {
	...
	PlayerId   uint64 `protobuf:"varint,1,opt,name=player_id,json=playerId,proto3" json:"player_id,omitempty"`
	Score      int32  `protobuf:"varint,2,opt,name=score,proto3" json:"score,omitempty"`
	GameNumber int32  `protobuf:"varint,3,opt,name=game_number,json=gameNumber,proto3" json:"game_number,omitempty"`
}
...
func (x *CreateHandRequest_PlayerScore) GetGameNumber() int32 {
	if x != nil {
		return x.GameNumber
	}
	return 0
...
var file_app_services_hand_v1_service_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x0a, 0x67, 0x61, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x44,
